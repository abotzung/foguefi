...
void injectKeyEvent(uint16_t code, uint16_t value)
{
    ...
    if(value!=0){
		//write(kbdfd, &code, 2);
		// UP Arrow code = 65362
		// DOWN Arrow code = 65364
		// LEFT Arrow code = 65361
		// RIGHT Arrow code = 65363
		//CHR(27)+[2;10H
		
		switch (code)
        {
		case XK_Left:
			i=0x1B; ioctl(kbdfd, TIOCSTI, &i);
			i='['; ioctl(kbdfd, TIOCSTI, &i);
			i='D'; ioctl(kbdfd, TIOCSTI, &i);
			break;
		case XK_Right:
			i=0x1B; ioctl(kbdfd, TIOCSTI, &i);
			i='['; ioctl(kbdfd, TIOCSTI, &i);
			i='C'; ioctl(kbdfd, TIOCSTI, &i);
			break;	
		case XK_Up:
			i=0x1B; ioctl(kbdfd, TIOCSTI, &i);
			i='['; ioctl(kbdfd, TIOCSTI, &i);
			i='A'; ioctl(kbdfd, TIOCSTI, &i);
			break;		
		case XK_Down:
			i=0x1B; ioctl(kbdfd, TIOCSTI, &i);
			i='['; ioctl(kbdfd, TIOCSTI, &i);
			i='B'; ioctl(kbdfd, TIOCSTI, &i);
			break;	
        case XK_BackSpace:      ioctl(kbdfd, TIOCSTI, &code);       break;  //ff08
        case XK_Escape:         ioctl(kbdfd, TIOCSTI, &code);       break;  //ff1b
        case XK_Tab:            ioctl(kbdfd, TIOCSTI, &code);       break;  //ff09
        case XK_Return:         ioctl(kbdfd, TIOCSTI, &code);       break;  //ff0d
        case XK_F1:             ioctl(kbdfd, TIOCSTI, &code);       break;  //ffbe
        case XK_F2:             ioctl(kbdfd, TIOCSTI, &code);       break;  //ffbf
        case XK_F3:             ioctl(kbdfd, TIOCSTI, &code);       break;  //ffc0
        case XK_F4:             ioctl(kbdfd, TIOCSTI, &code);       break;  //ffc1
        case XK_F5:             ioctl(kbdfd, TIOCSTI, &code);       break;  //ffc2
        case XK_F6:             ioctl(kbdfd, TIOCSTI, &code);       break;  //ffc3
        case XK_F7:             ioctl(kbdfd, TIOCSTI, &code);       break;  //ffc4
        case XK_F8:             ioctl(kbdfd, TIOCSTI, &code);       break;  //ffc5
        case XK_F9:             ioctl(kbdfd, TIOCSTI, &code);       break;  //ffc6
        case XK_F10:            ioctl(kbdfd, TIOCSTI, &code);       break;  //ffc7
        case XK_F11:            ioctl(kbdfd, TIOCSTI, &code);       break;  //ffc8
        case XK_F12:            ioctl(kbdfd, TIOCSTI, &code);       break;  //ffc9

        case XK_Home:           ioctl(kbdfd, TIOCSTI, &code);       break;  //ff50
        case XK_Page_Up:        ioctl(kbdfd, TIOCSTI, &code);       break;  //ff55
        case XK_Page_Down:      ioctl(kbdfd, TIOCSTI, &code);       break;  //ff56
        case XK_End:            ioctl(kbdfd, TIOCSTI, &code);       break;  //ff57
        case XK_Begin:          ioctl(kbdfd, TIOCSTI, &code);       break;  //ff58

        case XK_Shift_L: 	                                        break; //ffe1
        case XK_Shift_R:        									break; //ffe2
        case XK_Control_L:                                          break; //ffe3
        case XK_Control_R:                                          break; //ffe4
        case XK_Alt_L:                                              break;  //ffe9
        case XK_Alt_R:                                              break; //ffea			
		default:
			if(code<255){
				ioctl(kbdfd, TIOCSTI, &code);
			}
			break;
		}
